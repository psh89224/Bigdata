...
# Calculate value frqquencies
print(wine.quality.value_counts())

# Display descriptive statistics for quality ny wine type
...
print(wine.corr())  # correlation (상관관계)
...
print("print: g")
print(g)
plt.suptitle('Histograms and Scatter Plots of Quality, Alcohol, and Residual Suger', \
