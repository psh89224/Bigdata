...
# Specify different statistics for dirrerent variables
...
# Create total_charges, split it into 5 groups, and Calculate statistics for each of the groups
...
# Create binary/dummy indicator variables for intl_plan and vmail_plan and join them with the churn column in a new DataFrame
...
# Split total_charge into quartiles, create binary indicator variables for each of the quartiles,
# and add them to the churn DataFrame
...
print(churn.pivot_table(['total_charges'], index=['custserv_calls'], columns=['churn'], aggfunc='mean', \
                        fill_value='NaN', margins=True))
